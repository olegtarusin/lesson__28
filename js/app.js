(() => {
    ...
    function initSliders() {
        if (document.querySelector(".coments__slider")) new swiper_core_Swiper(".coments__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            speed: 800,
            pagination: {
                el: ".coments__pagination.swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
...
***************************************************************************** */
    ...
    addClasser(".galery__show-more");
    addClasser(".galery__item-navigation");
    addClasser(".linkline__item");
    addClasser(".person__name");
    window["FLS"] = true;
    isWebp();
    addTouchClass();
})();